...
function Hero() {
  ...
  return (
    <section className="w-full isolate min-h-screen overflow-hidden relative">
      ...
      {/* Hero content */}
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-24 sm:pt-40 lg:pt-52 text-center">
        {/* Badge */}
        <div className="mb-6 inline-flex items-center gap-3 rounded-full bg-white/10 px-3 py-2 ring-1 ring-white/15 backdrop-blur animate-fade-slide-in-1">
        ...
        <h1
          className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-white leading-[1.05] tracking-tight font-normal animate-fade-slide-in-2 mb-6"
        ...
        <p className="text-lg sm:text-xl text-white/60 max-w-2xl mx-auto leading-relaxed animate-fade-slide-in-3 mb-10" style={{ fontFamily: 'var(--font-sans)' }}>
    ...
    <section id="features" className="bg-[#0a0a0a] py-28 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl sm:text-5xl text-white font-normal leading-tight" style={{ fontFamily: 'var(--font-serif)' }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {FEATURES.map((f) => (
            <div
              key={f.title}
              className="group bg-white/[0.02] hover:bg-white/[0.04] border border-white/[0.06] hover:border-orange-500/20 rounded-2xl p-7 transition-all duration-300"
            >
    ...
    <section id="how-it-works" className="bg-[#0c0c0c] py-28 px-6 border-y border-white/[0.04]">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl sm:text-5xl text-white font-normal" style={{ fontFamily: 'var(--font-serif)' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {STEPS.map((step, i) => (
            <div key={step.num} className="relative">
              {i < STEPS.length - 1 && (
                <div className="hidden md:block absolute top-8 left-full w-full h-px bg-gradient-to-r from-orange-500/20 to-transparent z-10" style={{ width: 'calc(100% - 2rem)' }} />
              )}
              <div className="flex flex-col">
                <div className="text-5xl font-bold text-orange-500/15 mb-4 leading-none" style={{ fontFamily: 'var(--font-serif)' }}>{step.num}</div>
    ...
    <section id="pricing" className="bg-[#0a0a0a] py-28 px-6">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl sm:text-5xl text-white font-normal" style={{ fontFamily: 'var(--font-serif)' }}>Simple, transparent pricing</h2>
  ...
  return (
    <section className="bg-[#0c0c0c] border-t border-white/[0.04] py-24 px-6">
      <div className="max-w-3xl mx-auto text-center">
        <h2 className="text-4xl sm:text-5xl text-white font-normal mb-5 leading-tight" style={{ fontFamily: 'var(--font-serif)' }}>
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-6">
          {['Features', 'How It Works', 'Pricing'].map(link => (
            <a key={link} href={`#${link.toLowerCase().replace(/ /g, '-')}`} className="text-white/30 text-sm hover:text-white/70 transition" style={{ fontFamily: 'var(--font-sans)' }}>
              {link}
            </a>
          ))}
          <Link to="/login" className="text-white/30 text-sm hover:text-white/70 transition" style={{ fontFamily: 'var(--font-sans)' }}>Sign In</Link>
        </div>
